...
GC_34 = Coupling(name = 'GC_34',
                 value = '-((ee*complex(0,1)*gN)/(sw*cmath.sqrt(2)))',
                 order = {'QED':1,'QNP':1})

GC_35 = Coupling(name = 'GC_35',
                 value = '-(ee*complex(0,1)*gN)/(2.*cw*sw)',
                 order = {'QED':1,'QNP':1})

GC_36 = Coupling(name = 'GC_36',
                 value = '-(ee*complex(0,1)*gN*Mn1)/(2.*MW*sw)',
                 order = {'QED':1,'QNP':1})

GC_37 = Coupling(name = 'GC_37',
                 value = '-(ee*complex(0,1)*gN*Mn2)/(2.*MW*sw)',
                 order = {'QED':1,'QNP':1})

GC_38 = Coupling(name = 'GC_38',
                 value = '-(ee*complex(0,1)*gN*Mn3)/(2.*MW*sw)',
                 order = {'QED':1,'QNP':1})
...
GC_74 = Coupling(name = 'GC_74',
                 value = '2*complex(0,1)*gX*zn1',
                 order = {'QNP':1})

GC_75 = Coupling(name = 'GC_75',
                 value = '2*complex(0,1)*gX*zn2',
                 order = {'QNP':1})

GC_76 = Coupling(name = 'GC_76',
                 value = '2*complex(0,1)*gX*zn3',
                 order = {'QNP':1})
